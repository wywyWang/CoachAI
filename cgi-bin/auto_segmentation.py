...
def readData():
    ...
    df = pd.read_csv('./preprocessing/Data/TrainTest/TAI_Tzu_Ying_vs_CHEN_Yufei_2018_Indonesia_Open_Final_predict.csv')
    df = df[0:numFrame]
    dupl=[]
...
def segmentation(df):
    ...
    time = pd.read_csv('./preprocessing/Data/TrainTest/TAI_Tzu_Ying_vs_CHEN_Yufei_2018_Indonesia_Open_Final_predict.csv')
...
def on_off_court(df):
    ...
    plt.savefig('./preprocessing/Data/Statistics/Loss_reason.jpg', pad_inches = 0.5, transparent=True, bbox_inches = 'tight')
    ...
    # plt.savefig('./preprocessing/Data/Statistics/Rally_count.jpg', pad_inches = 0.5, transparent=True, bbox_inches = 'tight')

    # export_json('./preprocessing/Data/Statistics/rally_count.json',result)
...
def generateVideo(df,df_complete,numFrame):
    ...
    input_video_path = './preprocessing/Data/PredictVideo/TAI Tzu Ying vs CHEN Yufei 2018 Indonesia Open Final'
